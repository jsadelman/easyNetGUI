      ...
      m_animation_group(NULL)
{
    ...
    // MG: m_opt_automatic_graph_layout should be always true,
    // so that GraphLayout::ignoreEdges is always false and layout is computed
    m_opt_automatic_graph_layout = true;
...
//    int cxoff, cyoff;
//    // the following line had a bug: absolutePath -> absoluteFilePath
...
//    deselectAll();
    ...
    {
        item->moveByDifference(difference);
