...
class Connector : public CanvasItem
{
    ...
    public:
        ...
        void setRoutingCheckPoints(const QList<QPointF>& checkpoints, Avoid::Router* router=0);
    ...
    protected:
        ...
        Avoid::Point multiEdgeOffset(double nx, double ny);
